...
extension UIView {
    public func constrainEqual(_ attribute: NSLayoutConstraint.Attribute, to: Any, multiplier: CGFloat = 1, constant: CGFloat = 0) {
        constrainEqual(attribute, to: to, attribute, multiplier: multiplier, constant: constant)
    }
    
    public func constrainEqual(_ attribute: NSLayoutConstraint.Attribute, to: Any, _ toAttribute: NSLayoutConstraint.Attribute, multiplier: CGFloat = 1, constant: CGFloat = 0) {
...
extension NSLayoutAnchor {
    @objc public func constrain(equalTo anchor: NSLayoutAnchor<AnchorType>, constant: CGFloat = 0) {
