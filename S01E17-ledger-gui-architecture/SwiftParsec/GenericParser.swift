...
public extension Parsec {
    ...
    static func tokenPrimitive(tokenDescription: @escaping (StreamType.Element) -> String, nextPosition: @escaping (SourcePosition, StreamType.Element, StreamType) -> SourcePosition, match: @escaping (StreamType.Element) -> Result?) -> GenericParser<StreamType, UserState, Result> {
...
public extension Parsec where StreamType.Element: Equatable {
    ...
    static func tokens<OtherStream: Stream>(tokensDescription: @escaping (OtherStream) -> String, nextPosition: @escaping (SourcePosition, OtherStream) -> SourcePosition, tokens: OtherStream) -> GenericParser<StreamType, UserState, OtherStream> where OtherStream.Element == StreamType.Element {
        ...
        return GenericParser(parse: { state in
            ...
            repeat {
                ...
                if token != inputToken {
                    ...
                    let tokDesc = tokensDescription([inputToken] as! OtherStream.ArrayLiteralElement as! OtherStream)
...
public func <*<StreamType, UserState, Param1, Param2>(leftParser: GenericParser<StreamType, UserState, Param1>, rightParser: GenericParser<StreamType, UserState, Param2>) -> GenericParser<StreamType, UserState, Param1> {
    ...
    return GenericParser.lift2({ param1, param2 in
        return param1
    }, parser1: leftParser, parser2: rightParser)
