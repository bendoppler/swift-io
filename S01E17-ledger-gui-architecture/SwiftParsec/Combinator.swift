...
public extension GenericParser where StreamType.Element: Equatable {
    ...
    func onlyIf(peek check: @escaping (StreamType.Element) -> Bool) -> GenericParser<StreamType, UserState, Result> {
...
public extension GenericParser {
    ...
    static func choice<S: Sequence>(_ parsers: S) -> GenericParser where S.Iterator.Element == GenericParser {
    ...
    func between<U, V>(_ opening: GenericParser<StreamType, UserState, U>, _ closing: GenericParser<StreamType, UserState, V>) -> GenericParser {
    ...
    func separatedBy<Separator>(_ separator: GenericParser<StreamType, UserState, Separator>) -> GenericParser<StreamType, UserState, [Result]> {
    ...
    func separatedBy1<Separator>(_ separator: GenericParser<StreamType, UserState, Separator>) -> GenericParser<StreamType, UserState, [Result]> {
    ...
    func dividedBy<Separator>(_ separator: GenericParser<StreamType, UserState, Separator>, endSeparatorRequired: Bool = true) -> GenericParser<StreamType, UserState, [Result]> {
    ...
    func dividedBy1<Separator>(_ separator: GenericParser<StreamType, UserState, Separator>, endSeparatorRequired: Bool = true) -> GenericParser<StreamType, UserState, [Result]> {
    ...
    func count(_ n: Int) -> GenericParser<StreamType, UserState, [Result]> {
    ...
    func chainRight(_ oper: GenericParser<StreamType, UserState, (Result, Result) -> Result>, otherwise: Result) -> GenericParser {
    ...
    func chainRight1(_ oper: GenericParser<StreamType, UserState, (Result, Result) -> Result>) -> GenericParser {
    ...
    ///   - otherwise: Default value returned when there are no occurences of `self`.
    /// - returns: A parser that parses _zero_ or more occurrences of `self`, separated by `oper`.
    func chainLeft(_ oper: GenericParser<StreamType, UserState, (Result, Result) -> Result>, otherwise: Result) -> GenericParser {
    ...
    /// - parameter oper: The operator parser.
    /// - returns: A parser that parses _one_ or more occurrences of `self`, separated by `oper`.
    func chainLeft1(_ oper: GenericParser<StreamType, UserState, (Result, Result) -> Result>) -> GenericParser {
    ...
    func manyTill<End>(_ end: GenericParser<StreamType, UserState, End>) -> GenericParser<StreamType, UserState, [Result]> {
    ...
    static func recursive(_ combine: (GenericParser) -> GenericParser) -> GenericParser {
