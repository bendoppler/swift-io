...
public extension Parsec where StreamType.Element == Character, Result == Character {
    ...
    static func satisfy(_ predicate: @escaping (Character) -> Bool) -> GenericParser<StreamType, UserState, Result> {
    ...
    static func oneOf(_ list: String) -> GenericParser<StreamType, UserState, Result> {
    ...
    /// - SeeAlso: `GenericParser.satisfy(predicate: Character -> Bool) -> GenericParser`
    static func oneOf(_ interval: ClosedRange<Character>) -> GenericParser<StreamType, UserState, Result> {
    ...
    static func noneOf(_ list: String) -> GenericParser<StreamType, UserState, Result> {
    ...
    static func character(_ char: Character) -> GenericParser<StreamType, UserState, Result> {
...
public extension Parsec where StreamType.Element == Character {
    ...
    static func string<StringStream: Stream>(_ str: StringStream) -> GenericParser<StreamType, UserState, StringStream> where StringStream.Element == Character {
