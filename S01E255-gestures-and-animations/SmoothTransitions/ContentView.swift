...
struct ContentView: View {
    ...
    func size(for id: Item.ID) -> CGSize {
        ...
        return interpolatedSize(factor: factor)
    }
    ...
    var animation: Animation {
        Animation.default.speed(slowAnimations ? 0.2 : 1.0)
    }
        ...
        ZStack {
            ...
            if let item = currentItem, fullScreen {
                ...
                CardView(item: item)
                    ...
                    .frame(minWidth: 0, maxWidth: .infinity, minHeight: 0, maxHeight: .infinity) // for proposed size
