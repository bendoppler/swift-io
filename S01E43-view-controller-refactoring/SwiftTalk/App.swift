...
final class EpisodeNavigationDelegate: NSObject, UINavigationControllerDelegate {
    func navigationController(_ navigationController: UINavigationController, willShow viewController: UIViewController, animated: Bool) {
        let isRootViewController = navigationController.viewControllers.first === viewController
        navigationController.setNavigationBarHidden(!isRootViewController, animated: animated)
    }
}
