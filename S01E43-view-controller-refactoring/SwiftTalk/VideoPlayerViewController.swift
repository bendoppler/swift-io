...
public final class VideoPlayerViewController: UIViewController {
    ...
    public var thumbnail: UIImage? {
        didSet {
            ...
            let artwork = AVMetadataItem.item(identifier: AVMetadataIdentifier.commonIdentifierArtwork.rawValue, image: thumbnail)
    ...
    public init(episode: Episode) {
        ...
        playerItem.externalMetadata = [
            AVMetadataItem.item(identifier: AVMetadataIdentifier.commonIdentifierTitle.rawValue, value: episode.title),
            AVMetadataItem.item(identifier: AVMetadataIdentifier.commonIdentifierDescription.rawValue, value: episode.synopsis)
        ]
